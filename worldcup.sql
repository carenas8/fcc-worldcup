...
--
-- Name: teams_games_tg_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.teams_games_tg_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.teams_games_tg_id_seq OWNER TO freecodecamp;

--
-- Name: teams_games_tg_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.teams_games_tg_id_seq OWNED BY public.teams_games.tg_id;
...
--
-- Name: teams_games tg_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.teams_games ALTER COLUMN tg_id SET DEFAULT nextval('public.teams_games_tg_id_seq'::regclass);
...
INSERT INTO public.teams_games VALUES (153, 2014, 'Eighth-Final', 7, 'Brazil');
INSERT INTO public.teams_games VALUES (154, 2014, 'Eighth-Final', 20, 'Chile');
INSERT INTO public.teams_games VALUES (155, 2014, 'Eighth-Final', 9, 'Colombia');
INSERT INTO public.teams_games VALUES (156, 2014, 'Eighth-Final', 8, 'Uruguay');
INSERT INTO public.teams_games VALUES (157, 2014, 'Eighth-Final', 1, 'France');
INSERT INTO public.teams_games VALUES (158, 2014, 'Eighth-Final', 21, 'Nigeria');
INSERT INTO public.teams_games VALUES (159, 2014, 'Eighth-Final', 17, 'Germany');
INSERT INTO public.teams_games VALUES (160, 2014, 'Eighth-Final', 22, 'Algeria');
INSERT INTO public.teams_games VALUES (161, 2014, 'Eighth-Final', 18, 'Netherlands');
INSERT INTO public.teams_games VALUES (162, 2014, 'Eighth-Final', 12, 'Mexico');
INSERT INTO public.teams_games VALUES (163, 2014, 'Eighth-Final', 19, 'Costa Rica');
INSERT INTO public.teams_games VALUES (164, 2014, 'Eighth-Final', 23, 'Greece');
INSERT INTO public.teams_games VALUES (165, 2014, 'Eighth-Final', 16, 'Argentina');
INSERT INTO public.teams_games VALUES (166, 2014, 'Eighth-Final', 10, 'Switzerland');
INSERT INTO public.teams_games VALUES (167, 2014, 'Eighth-Final', 3, 'Belgium');
INSERT INTO public.teams_games VALUES (168, 2014, 'Eighth-Final', 24, 'United States');
...
--
-- Name: teams_games_tg_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.teams_games_tg_id_seq', 168, true);
...
ALTER TABLE ONLY public.teams_games
    ADD CONSTRAINT teams_games_pkey PRIMARY KEY (tg_id);
...
--
-- Name: teams_games teams_games_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.teams_games
    ADD CONSTRAINT teams_games_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.teams(team_id);
